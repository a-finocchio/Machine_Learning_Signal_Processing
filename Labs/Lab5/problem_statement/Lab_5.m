...
% 
% 1. A completed |Lab_5.mlx| with the corresponding |nmf.m|, |ssnmf.m|, |compute_objective.m|, 
% |compute_objective_ss.m| files.
% 
% 2. A completed |Lab_5.m| file *and *an exported PDF with the corresponding 
...
% columns of your $B$ and $W$ normalize to $1$.
